...
describe('GET /api/quiz/start', () => {
  ...
  it('returns 401 when unauthenticated', async () => {
    ...
    const req = new NextRequest('http://localhost/api/quiz/start?account_id=00000000-0000-0000-0000-000000000001')
  ...
  it('returns 400 when account_id missing', async () => {
    ...
    const req = new NextRequest('http://localhost/api/quiz/start')
    const res = await GET(req)
