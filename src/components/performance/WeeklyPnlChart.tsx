...
export function WeeklyPnlChart({ data }: Props) {
  if (data.length === 0) {
    return (
      <Card className="border-border/60">
        <CardHeader className="pb-2">
          <CardTitle className="text-base">Wöchentliches P&L</CardTitle>
        </CardHeader>
        <CardContent>
  ...
  return (
    <Card className="border-border/60">
      <CardHeader className="pb-2">
        <CardTitle className="text-base">Wöchentliches P&L (letzte 12 Wochen)</CardTitle>
      </CardHeader>
